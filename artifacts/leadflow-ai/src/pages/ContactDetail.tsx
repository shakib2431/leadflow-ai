  ...
  if (!contact) {
    return (
      <div className="min-h-screen bg-[#0a0a0f] text-white p-10">
        <Link to="/contacts" className="inline-flex items-center gap-2 text-violet-400 hover:text-white mb-6">
  ...
  return (
    <div className="min-h-screen bg-[#07070a] text-white p-8 max-w-[1600px] mx-auto">
      <div className="grid grid-cols-1 lg:grid-cols-[2fr_1fr] gap-6 mb-10 items-start">
        <div>
          <Link to="/contacts" className="inline-flex items-center gap-2 text-white/40 hover:text-white mb-4 transition-colors">
            <ArrowLeft size={16} /> Back to contacts
          </Link>
        ...
        <div className="space-y-6">
          <div className="bg-[#111827] border border-white/10 rounded-3xl p-6">
            ...
            <div className="grid gap-3">
              ...
              <Link to="/contacts" className="block rounded-2xl bg-transparent border border-violet-500/30 px-4 py-3 hover:bg-violet-500/10 transition-all text-sm font-semibold">Return to contact list</Link>
            </div>
          </div>
