        ...
        <div className="space-y-6 sticky top-6">
          ...
          <div className="bg-[#111827] border border-white/10 rounded-3xl p-6">
            ...
            <div className="space-y-3">
              ...
              <Link to={`/workspace/${lead.id}`} className="w-full h-12 rounded-xl border border-green-500/30 hover:bg-green-500/10 flex items-center justify-center text-sm font-medium">
                🧠 Open AI Workspace
              </Link>
