...
export default function CompanyDetailPage() {
  ...
  if (!company) return (
    <div className="p-10 text-white">
      ...
      <Link href="/companies" className="block mt-6 text-violet-400 hover:underline">← Back to Database</Link>
    </div>
  );

  return (
    <div className="p-8 bg-[#07070a] min-h-screen text-white">
      <Link href="/companies" className="flex items-center gap-2 text-white/40 hover:text-white mb-8 transition-colors">
