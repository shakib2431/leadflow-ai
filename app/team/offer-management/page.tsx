      ...
      <div className="hrms-main-with-nav">
        ...
        <section className="hrms-dashboard-shell">
          <div className="mb-4 flex items-center justify-between">
            ...
            <Link href="/team/pre-onboarding" className="flex items-center gap-1.5 text-xs font-semibold text-indigo-600 hover:text-indigo-800 transition">
          ...
          {loading ? (
            ...
            <div className="rounded-xl border border-dashed border-slate-300 bg-slate-50 py-12 text-center">
              ...
              <Link href="/team/recruitment" className="mt-4 inline-flex items-center gap-2 rounded-xl bg-indigo-600 px-4 py-2 text-sm font-semibold text-white hover:bg-indigo-700 transition">
                Open Recruitment
              </Link>
            </div>
          ) : (
                  ...
                  <article key={employee.id} className={`rounded-xl border p-4 transition hover:shadow-md ${sc.cls}`}>
                    <div className="flex flex-wrap items-start justify-between gap-3">
                      ...
                      <div className="flex flex-wrap items-center gap-2">
                        ...
                        <Link href={`/hrms/v2/employees/${employee.id}`} className="flex items-center gap-1.5 rounded-xl border border-slate-200 bg-white px-3 py-2 text-xs font-semibold text-slate-700 hover:border-slate-300 transition">
        ...
        <div className="flex flex-wrap gap-3">
          <Link href="/team/recruitment" className="flex items-center gap-1.5 rounded-xl border border-slate-200 bg-white px-4 py-2.5 text-sm font-semibold text-slate-700 hover:border-indigo-300 hover:text-indigo-700 transition">
          ...
          <Link href="/hrms/v2/templates" className="flex items-center gap-1.5 rounded-xl border border-slate-200 bg-white px-4 py-2.5 text-sm font-semibold text-slate-700 hover:border-indigo-300 hover:text-indigo-700 transition">
