              ...
              <div ref={profileMenuRef} className="relative">
                ...
                {showProfileMenu && (
                  <div className="absolute right-0 z-20 mt-2 w-52 rounded-xl border border-[#e4e7ec] bg-white p-1.5 shadow-lg">
                    <Link to="/hrms/v2/settings" className="block rounded-lg px-2.5 py-2 text-sm text-[#344054] hover:bg-[#f9fafb]">Profile Settings</Link>
                    <button
                      onClick={async () => {
              ...
              return (
                <div key={stage.key} className="rounded-2xl border border-[#eaecf5] bg-white">
                  ...
                  <div className="space-y-2 p-3">
                    ...
                    <Link to="#pre-onboarding-table" className="block px-1 pt-1 text-xs font-semibold text-[#4f46e5] hover:underline">
