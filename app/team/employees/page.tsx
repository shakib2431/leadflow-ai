        ...
        <HRMSHeaderWithFilters
          ...
          actions={
            <div className="flex items-center gap-2">
              ...
              <Link href="/team/onboarding" className="hrms-btn hrms-btn-primary inline-flex items-center gap-2 px-4 py-2 text-sm">
        ...
        <div className="hrms-dashboard-shell">
          ...
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center rounded-xl border border-dashed border-slate-300 bg-slate-50 py-16 text-center">
              ...
              {tab === "active" && (
                <Link href="/team/onboarding" className="mt-4 inline-flex items-center gap-2 rounded-xl bg-indigo-600 px-4 py-2 text-sm font-semibold text-white hover:bg-indigo-700 transition">
                      ...
                      <tr key={emp.id} className="hover:bg-slate-50 transition">
                        ...
                        <td className="px-4 py-3 text-right">
                          <div className="inline-flex items-center gap-2">
                            ...
                            <Link href={`/hrms/v2/employees/${emp.id}`} className="inline-flex items-center gap-1 rounded-lg border border-slate-200 bg-white px-2.5 py-1.5 text-xs font-semibold text-slate-700 hover:border-indigo-300 hover:text-indigo-700 transition">
                              <Eye size={11} /> View
                            </Link>
                          </div>
                        </td>
