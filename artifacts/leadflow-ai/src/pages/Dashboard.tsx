          ...
          <main className="flex-1 overflow-y-auto p-6 lg:p-10 custom-scrollbar relative">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10 fade-in fade-in-1">
              ...
              <div className="flex items-center gap-3">
                ...
                <Link to="/import" className="flex items-center gap-2 px-4 py-2.5 rounded-xl text-xs font-bold uppercase tracking-wider text-white/60 bg-black/40 border border-white/[0.06] hover:text-white/90 hover:bg-white/5 transition-all">
                  <Upload size={14} /> Import Data
                </Link>
                <Link to="/export" className="flex items-center gap-2 px-4 py-2.5 rounded-xl text-xs font-bold uppercase tracking-wider text-white/60 bg-black/40 border border-white/[0.06] hover:text-white/90 hover:bg-white/5 transition-all">
                    ...
                    return (
                      <div key={item.id} className="bg-[#0d0e12] border border-white/[0.06] rounded-2xl p-5 lg:p-6 flex flex-col lg:flex-row gap-6 items-start lg:items-center justify-between hover:border-violet-500/30 transition-all duration-300 shadow-xl shadow-black/20 group">
                        ...
                        <div className="flex flex-row gap-3 w-full lg:w-auto shrink-0 justify-end">
                          ...
                          <Link to={`/leads/${item.lead_id}`} className="px-5 py-3 bg-white/5 hover:bg-white/10 text-white/80 text-sm font-bold tracking-wide rounded-xl border border-white/10 flex items-center justify-center gap-2 transition-all">
