...
      icon: Sparkles,
      section: "Actions",
      perform: () => { navigate("/action-queue"); setOpen(false); }
    },
    {
      id: "nav-dash",
...
      section: "Navigation",
      perform: () => { navigate("/"); setOpen(false); }
    },
    {
      id: "nav-inbox",
...
      icon: Mail,
      section: "Navigation",
      perform: () => { navigate("/inbox"); setOpen(false); }
    },
    {
      id: "nav-pipeline",
...
      icon: Layers,
      section: "Navigation",
      perform: () => { navigate("/pipeline"); setOpen(false); }
    },
    {
      id: "nav-companies",
...
      icon: Building2,
      section: "Navigation",
      perform: () => { navigate("/companies"); setOpen(false); }
    },
    {
      id: "nav-contacts",
...
      icon: Users,
      section: "Navigation",
      perform: () => { navigate("/contacts"); setOpen(false); }
    },
    {
      id: "nav-playbooks",
...
      icon: Bot,
      section: "Navigation",
      perform: () => { navigate("/playbooks"); setOpen(false); }
    },
    {
      id: "recent-valerin",
