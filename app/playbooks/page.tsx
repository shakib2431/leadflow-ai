      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden relative z-10">
        <div className="flex items-center justify-between border-b border-white/[0.04] bg-[#0c0d12]/80 backdrop-blur-md z-30 relative">
          ...
          <div className="mr-6 flex items-center gap-3">
            <Link href="/playbooks/enroll" className="flex items-center gap-2 bg-indigo-500/10 text-indigo-400 hover:bg-indigo-500/20 text-sm font-bold px-5 py-2.5 rounded-xl transition-all border border-indigo-500/20">
              <Users size={16} /> Enroll Leads
            </Link>
            <Link href="/playbooks/builder" className="flex items-center gap-2 bg-zinc-100 text-zinc-900 hover:bg-white text-sm font-bold px-5 py-2.5 rounded-xl transition-all shadow-[0_0_20px_rgba(255,255,255,0.1)]">
        ...
        <main className="flex-1 overflow-y-auto p-6 lg:p-10 custom-scrollbar">
          ...
          {loading ? (
            ...
            <div className="bg-white/[0.02] border border-white/[0.05] rounded-3xl p-16 text-center flex flex-col items-center">
              ...
              <Link href="/playbooks/builder" className="bg-indigo-600 hover:bg-indigo-500 text-white px-6 py-2.5 rounded-xl text-sm font-bold transition-all shadow-[0_0_20px_rgba(79,70,229,0.3)]">
