    ...
    <main className="hrms-enterprise min-h-screen px-4 py-6 md:px-8 md:py-8">
      ...
      <div className="hrms-main-with-nav">
        ...
        {loading ? (
          ...
          <div className="hrms-dashboard-shell flex flex-col items-center justify-center py-16 text-center">
            ...
            <div className="mt-4 flex gap-3">
              <Link to="/team/employees" className="inline-flex items-center gap-2 rounded-xl bg-indigo-600 px-4 py-2 text-sm font-semibold text-white hover:bg-indigo-700 transition">
                <Users size={14} /> View Employee Directory
              </Link>
              <Link to="/team/pre-onboarding" className="inline-flex items-center gap-2 rounded-xl border border-slate-200 bg-white px-4 py-2 text-sm font-semibold text-slate-700 hover:border-indigo-300 hover:text-indigo-700 transition">
          ...
          <section className="hrms-dashboard-shell">
            <div className="mb-4 flex items-center justify-between">
              ...
              <Link to="/team/employees" className="flex items-center gap-1.5 text-xs font-semibold text-indigo-600 hover:text-indigo-800 transition">
                  ...
                  <article key={emp.id} className={`rounded-xl border transition ${canActivate ? "border-emerald-200 bg-emerald-50" : "border-slate-200 bg-white"}`}>
                    <div className="flex flex-wrap items-start justify-between gap-3 p-4">
                      ...
                      <div className="flex flex-wrap items-center gap-2">
                        ...
                        {!isActive && !canActivate && (
                          <Link to="/team/pre-onboarding" className="flex items-center gap-1.5 rounded-xl border border-indigo-200 bg-indigo-50 px-3 py-2 text-xs font-semibold text-indigo-700 hover:bg-indigo-100 transition">
                            Review Pre-Onboarding
                          </Link>
                        )}
                        <button
                          onClick={() => navigate(`/team/onboarding/${emp.id}`)}
                        ...
                        <div>
                          ...
                          {!canActivate && (
                            <p className="mt-3 text-xs text-amber-700 bg-amber-50 border border-amber-200 rounded-lg px-3 py-2">
                              ...
                              <Link to="/team/pre-onboarding" className="underline font-semibold">Pre-Onboarding</Link> before activation.
                            </p>
                          )}
                        </div>
                      </div>
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <Link to="/team/employees" className="flex items-center gap-1.5 rounded-xl border border-slate-200 bg-white px-4 py-2.5 text-sm font-semibold text-slate-700 hover:border-indigo-300 hover:text-indigo-700 transition">
